...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'zglow ?(.*)', fromMe: true, desc: Lang.GLOW_DESC }, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'zglow ?(.*)', fromMe: false, desc: Lang.GLOW_DESC }, (async (message, match) => {
