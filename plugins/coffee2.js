https://videfikri.com/api/textmaker/coffeecup2/?text=Pikri%20gans
...
const dd = "Make coffee cup with your lovers name";
const ll = "need some word";

if (Config.WORKTYPE == 'private') {

    Asena.addCommand({ pattern: 'cof ?(.*)', fromMe: true, deleteCommand: false,  desc: dd }, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'cof ?(.*)', fromMe: false,deleteCommand: false, desc: dd}, (async (message, match) => {
