...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'bt ?(.*)', fromMe: true, deleteCommand: false, desc: Lang.BT_DESC }, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption: 'Made by X-Troid ðŸ›¸' })
    ...
    Asena.addCommand({ pattern: 'bt ?(.*)', fromMe: false, deleteCommand: false, desc: Lang.BT_DESC }, (async (message, match) => {
