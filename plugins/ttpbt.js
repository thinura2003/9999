...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'bt ?(.*)', fromMe: true, deleteCommand: false, }, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'bt ?(.*)', fromMe: false,deleteCommand: false, }, (async (message, match) => {
