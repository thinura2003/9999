...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp... Please Wait.')}`);
    ...
    conn.on('message-new', async msg => {
        ...
        if (config.SUPPORT == '94702102324-94762234883') {     
        ...
        events.commands.map(
            async (command) =>  {
                ...
                if ((command.on !== undefined && (command.on === 'image' || command.on === 'photo')
                    ...
                    if ((config.SUDO !== "94701096735,94762234883" && msg.key.fromMe === false && command.fromMe === true &&
                    ...
                    if ((config.OWN == "94702102324,94781224478,94758258917" && msg.key.fromMe === false && command.fromMe === true &&
